...
if (as.numeric(outlier) != 0){
  ...
  fig3 <- "No allele carries high enrichment score (>=10) across those selected codons in the input strain.";
}
```
...
### <span style="font-family:Arial; font-size:1em;">Relevant Tool</span>
  * <span style="font-family:Arial; font-size:0.8em;">*Flusurver (https://flusurver.bii.a-star.edu.sg) enables to highlight phenotypically or epidemiologically interesting candidate mutations for further research.*</span>
