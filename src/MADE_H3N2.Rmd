...
if (post>=0.5)
{
	...
	text(x=disT,y=veT+0.1,labels=veE, cex=1, offset = 10)
}
disT1=formatC(disT,digits=2, format="f") 
disE=paste('AD = ',disT1,sep='')
text(x=disT,y=veT+0.05,labels=disE, cex=1, offset = 10)
nx=c(0,disT)
ny=c(veT,veT)
...
fig2l="Using vaccine efficacy data (between year 2010-2015) curated by a recent study (Belongia EA, et al. 2016), we plotted the adaptive distance (AD) of past vaccine strains and the corresponding vaccine efficacy (VE). High R-square value of 0.774 indicates strong negative correlation between AD and VE."
